CREATE TABLE approvals (
    ...
    updated_at         DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, -- 반려 및 승인으로 인한 상태 변경 or 결재 제목 및 내용 변경 or 결재자 변경 시간 추적
...
CREATE TABLE approval_logs (
    ...
    approvel_id        BIGINT UNSIGNED NOT NULL, -- 결재를 처리한 사용자 ID (FK)
    status             ENUM('PENDING', 'APPROVED', 'REJECTED') NOT NULL, -- 결재 처리 유형
